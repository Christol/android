...
public class ByteUtil {
    ...
    public static long getPostion(long hight, long low) {
        return  (long) (hight << 16) | low;
    }

    public static long getHight(long num) {
        return  (num >> 16) & 0xffff;
    }

    public static long getLow(long num) {
        return  num & 0xffff;
    }

    public static int getHightToLow(int num) {
        return  ((num << 16) & 0xffff0000) + ((num >>> 16) & 0x0000ffff);
    }
    ...
    *2 的 n 次方
    ...
    public static int getUnsigned(long num) {// 32位无符号转换位有符号
        return (int) (num & 0x0FFFFFFFF);
    }

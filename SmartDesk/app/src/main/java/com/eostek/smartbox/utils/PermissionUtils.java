...
public class PermissionUtils {
    ...
    public static final int CODE_SET_TIME_ZONE = 10;
    ...
    public static final String PERMISSION_SET_TIME_ZONE = Manifest.permission.SET_TIME_ZONE;
...
//        }
        ...
        if (checkSelfPermission != PackageManager.PERMISSION_GRANTED) {
            ...
            if (activity.shouldShowRequestPermissionRationale( requestPermission)) {
            ...
            showMessageOKCancel(activity, "should open those permission",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                        	activity.requestPermissions(shouldRationalePermissionsList.toArray(new String[shouldRationalePermissionsList.size()]),
                                    CODE_MULTI_PERMISSION);
                            Log.d(TAG, "showMessageOKCancel requestPermissions");
                        }
                    });
